...
struct SimpleExtractorConfig {
  ...
  INST_AMPL_COMPUTERS::DerivativeBasedUsingExternalInstFreq<
      double, decltype(integrator), decltype(derivator),
      INST_FREQ_COMPUTERS::InstFreqDerivativeBasedKind::TimeAverage>
      inst_ampl_computer;
  ...
  template <Signal DataInT> void load(const DataInT &data_in) {
    data.base->vec->clear();
...
struct SimpleExtractorDoubleConfig {
  ...
  NP_DSP::ONE_D::INST_FREQ_COMPUTERS::PhaseBased<
      ...
      inst_freq_computer_for_opt_filter =
          NP_DSP::ONE_D::INST_FREQ_COMPUTERS::PhaseBased<
              double, decltype(integrator), decltype(derivator),
              NP_DSP::ONE_D::PHASE_COMPUTERS::InstFreqDerivativeBasedKind::
                  DeriveDouble,
  ...
  NP_DSP::ONE_D::INST_FREQ_COMPUTERS::PhaseBased<
      ...
      inst_freq_computer_for_mode_for_opt_filter =
          NP_DSP::ONE_D::INST_FREQ_COMPUTERS::PhaseBased<
              double, decltype(integrator), decltype(derivator),
              NP_DSP::ONE_D::PHASE_COMPUTERS::InstFreqDerivativeBasedKind::
                  DeriveDouble,
              decltype(phase_computer_for_mode)>(integrator, derivator,
                                                 phase_computer_for_mode);

  NP_DSP::ONE_D::FILTERS::InstFreqBased<
      double, NP_DSP::ONE_D::FILTERS::FilteringType::AverageBased,
      decltype(integrator), NP_DSP::ONE_D::FILTERS::InstFreqKind::Double>
      filter1 = NP_DSP::ONE_D::FILTERS::InstFreqBased<
          double, NP_DSP::ONE_D::FILTERS::FilteringType::AverageBased,
          decltype(integrator), NP_DSP::ONE_D::FILTERS::InstFreqKind::Double>(
          integrator);
...
struct AmplOptExtractorDoubleConfig {
  ...
  NP_DSP::ONE_D::INST_AMPL_COMPUTERS::HilbertTransformBased<
      NP_DSP::ONE_D::UTILITY_MATH::HTKind::Mull>
      inst_ampl_computer_for_filtering;
  ...
  NP_DSP::ONE_D::FILTERS::InstFreqBased<
      double, NP_DSP::ONE_D::FILTERS::FilteringType::AverageBased,
      decltype(integrator), NP_DSP::ONE_D::FILTERS::InstFreqKind::Double>
      non_opt_filter = NP_DSP::ONE_D::FILTERS::InstFreqBased<
          double, NP_DSP::ONE_D::FILTERS::FilteringType::AverageBased,
          decltype(integrator), NP_DSP::ONE_D::FILTERS::InstFreqKind::Double>(
          integrator);

  NP_DSP::ONE_D::FILTERS::EXPERIMENTAL::
      RecursiveFilterInstAmplChangesWithConstInstFreqDouble<
          double, decltype(integrator), decltype(derivator),
          decltype(non_opt_filter), decltype(inst_ampl_computer_for_filtering)>
          filter1 = NP_DSP::ONE_D::FILTERS::EXPERIMENTAL::
              RecursiveFilterInstAmplChangesWithConstInstFreqDouble<
                  double, decltype(integrator), decltype(derivator),
                  decltype(non_opt_filter),
                  decltype(inst_ampl_computer_for_filtering)>(
                  integrator, derivator, non_opt_filter,
                  inst_ampl_computer_for_filtering);

  // NP_DSP::ONE_D::FILTERS::RecursiveFilterInstAmplChangesDouble<double,
  // decltype(integrator), decltype(derivator),
  //     decltype(non_opt_filter3), decltype(phase_computer),
  //     decltype(inst_ampl_computer_for_filtering),
  //     decltype(inst_freq_computer_for_mode_for_opt_filter)>
  //         filter1 =
  //         NP_DSP::ONE_D::FILTERS::RecursiveFilterInstAmplChangesDouble<double,
  //         decltype(integrator), decltype(derivator),
  //     decltype(non_opt_filter3), decltype(phase_computer),
  //     decltype(inst_ampl_computer_for_filtering),
  //     decltype(inst_freq_computer_for_mode_for_opt_filter)>
  //         (integrator, derivator, non_opt_filter3, phase_computer,
  //         inst_ampl_computer_for_filtering,
  //         inst_freq_computer_for_mode_for_opt_filter);
  ...
  template <SignalBase DataInT> void load(const DataInT &data_in) {
    data.base->vec->clear();
    for (auto i = 0; i < data_in.size(); i++) {
      data.base->vec->push_back(data_in[i]);
    }
...
struct FreqOptExtractorDoubleConfig {
  ...
  NP_DSP::ONE_D::INST_AMPL_COMPUTERS::DerivativeAndInstFreqBased<
      double, decltype(integrator), decltype(derivator),
      decltype(inst_freq_computer_for_opt_filter),
      NP_DSP::ONE_D::INST_FREQ_COMPUTERS::InstFreqDerivativeBasedKind::
          DeriveDouble>
      inst_ampl_computer_for_filtering =
          NP_DSP::ONE_D::INST_AMPL_COMPUTERS::DerivativeAndInstFreqBased<
              double, decltype(integrator), decltype(derivator),
              decltype(inst_freq_computer_for_opt_filter),
              NP_DSP::ONE_D::INST_FREQ_COMPUTERS::InstFreqDerivativeBasedKind::
                  DeriveDouble>(integrator, derivator,
                                inst_freq_computer_for_opt_filter);
  ...
  NP_DSP::ONE_D::FILTERS::InstFreqBased<
      double, NP_DSP::ONE_D::FILTERS::FilteringType::ValueBased,
      decltype(integrator), NP_DSP::ONE_D::FILTERS::InstFreqKind::Double>
      non_opt_filter2 = NP_DSP::ONE_D::FILTERS::InstFreqBased<
          double, NP_DSP::ONE_D::FILTERS::FilteringType::ValueBased,
          decltype(integrator), NP_DSP::ONE_D::FILTERS::InstFreqKind::Double>(
          integrator);

  NP_DSP::ONE_D::FILTERS::CascadeFilter<double, decltype(non_opt_filter),
                                        decltype(non_opt_filter2)>
      cascade_filter = NP_DSP::ONE_D::FILTERS::CascadeFilter<
          double, decltype(non_opt_filter), decltype(non_opt_filter2)>(
          non_opt_filter, non_opt_filter2);

  NP_DSP::ONE_D::FILTERS::EXPERIMENTAL::OptPeriodBasedFilterInstFreqDouble<
      double, decltype(cascade_filter),
...
struct FreqAmplOptExtractorDoubleConfig {
  ...
  NP_DSP::ONE_D::FILTERS::EXPERIMENTAL::OptPeriodBasedFilterInstFreqDouble<
      ...
      decltype(inst_freq_computer_for_mode_for_opt_filter),
      decltype(phase_computer_for_mode)>
      opt_filter = NP_DSP::ONE_D::FILTERS::EXPERIMENTAL::
          OptPeriodBasedFilterInstFreqDouble<
              double, decltype(cascade_filter),
              decltype(inst_freq_computer_for_opt_filter),
              decltype(phase_computer),
  ...
  NP_DSP::ONE_D::FILTERS::EXPERIMENTAL::RecursiveFilterInstAmplChangesDouble<
      double, decltype(integrator), decltype(derivator), decltype(opt_filter),
      decltype(phase_computer), decltype(inst_ampl_computer_for_filtering),
      decltype(inst_freq_computer_for_mode_for_opt_filter)>
      filter1 = NP_DSP::ONE_D::FILTERS::EXPERIMENTAL::
          RecursiveFilterInstAmplChangesDouble<
              double, decltype(integrator), decltype(derivator),
              decltype(opt_filter), decltype(phase_computer),
              decltype(inst_ampl_computer_for_filtering),
              decltype(inst_freq_computer_for_mode_for_opt_filter)>(
              integrator, derivator, opt_filter, phase_computer,
              inst_ampl_computer_for_filtering,
              inst_freq_computer_for_mode_for_opt_filter);
...
struct AmplOptExtractorConfig {
  ...
  /*INST_AMPL_COMPUTERS::DerivativeBasedUsingExternalInstFreq<double,
     decltype(integrator), decltype(derivator),
      INST_FREQ_COMPUTERS::InstFreqDerivativeBasedKind::TimeAverage>
          inst_ampl_computer;*/
  NP_DSP::ONE_D::INST_AMPL_COMPUTERS::HilbertTransformBased<
  ...
  INST_FREQ_COMPUTERS::PhaseBased<
      ...
      INST_FREQ_COMPUTERS::InstFreqDerivativeBasedKind::TimeAverage,
      decltype(phase_computer)>
      inst_freq_computer_for_filter = INST_FREQ_COMPUTERS::PhaseBased<
          double, decltype(integrator), decltype(derivator),
          INST_FREQ_COMPUTERS::InstFreqDerivativeBasedKind::TimeAverage,
          decltype(phase_computer)>(integrator, derivator, phase_computer);
  ...
  INST_FREQ_COMPUTERS::PhaseBased<
      ...
      INST_FREQ_COMPUTERS::InstFreqDerivativeBasedKind::TimeAverage,
      decltype(phase_computer_for_mode)>
      inst_freq_computer_for_filter_for_mode = INST_FREQ_COMPUTERS::PhaseBased<
          double, decltype(integrator), decltype(derivator),
          INST_FREQ_COMPUTERS::InstFreqDerivativeBasedKind::TimeAverage,
          decltype(phase_computer_for_mode)>(integrator, derivator,
                                             phase_computer_for_mode);
  ...
  FILTERS::InstFreqBased<double, FILTERS::FilteringType::AverageBased,
      ...
      non_opt_filter =
          FILTERS::InstFreqBased<double, FILTERS::FilteringType::AverageBased,
                                 decltype(integrator),
                                 FILTERS::InstFreqKind::Average>(integrator);

  FILTERS::EXPERIMENTAL::RecursiveFilterInstAmplChangesWithConstInstFreq<
      double, decltype(integrator), decltype(derivator),
      decltype(non_opt_filter), decltype(inst_ampl_computer_for_filter)>
      filter2 = FILTERS::EXPERIMENTAL::
          RecursiveFilterInstAmplChangesWithConstInstFreq<
              double, decltype(integrator), decltype(derivator),
              decltype(non_opt_filter),
              decltype(inst_ampl_computer_for_filter)>(
              integrator, derivator, non_opt_filter,
              inst_ampl_computer_for_filter);
...
struct AmplOptExtractorDoubleAlternationFreqConfig {
  ...
  /*NP_DSP::ONE_D::FILTERS::RecursiveFilterInstAmplChangesDouble<double,
     decltype(integrator), decltype(derivator), decltype(non_opt_filter2),
     decltype(phase_computer), decltype(inst_ampl_computer_for_filtering),
     decltype(inst_freq_computer_for_mode_for_opt_filter)> filter1 =
          NP_DSP::ONE_D::FILTERS::RecursiveFilterInstAmplChangesDouble<double,
     decltype(integrator), decltype(derivator), decltype(non_opt_filter2),
     decltype(phase_computer), decltype(inst_ampl_computer_for_filtering),
     decltype(inst_freq_computer_for_mode_for_opt_filter)> (integrator,
     derivator, non_opt_filter2, phase_computer,
     inst_ampl_computer_for_filtering,
     inst_freq_computer_for_mode_for_opt_filter); */
...
struct BySizeLogStopFunc {
  ...
  template <typename Config>
  bool CheckStop(size_t iter_number, Config &config) {
    if (std::log2(static_cast<double>(config.data.size())) * log_muller <
        iter_number) {
      return true;
    }
    return false;
...
struct ByMaxPhaseStopFunc {
  ...
  template <typename Config>
  bool CheckStop(size_t iter_number, Config &config) {
    if ((*config.phases[config.phases.size() -
                        1])[(*config.phases[config.phases.size() - 1]).size() -
                            1] <= min_phase) {
      return true;
    }
    return false;
...
void computeReq(Config &config, Stop &stop) {
  ...
  for (;;) {
    ...
    config.phase_computer.compute(config.data, *config.phases[iter_number],
                                  nullptr);
    // phases[iter_number]->show(PlottingKind::Simple);
    config.inst_freq_computer.compute(*config.phases[iter_number],
                                      *config.inst_freqs[iter_number], nullptr);
    config.filter1.compute(config.data, *config.modes[iter_number],
                           config.inst_freqs[iter_number]);
    // config.modes[iter_number]->show(PlottingKind::Simple);
    for (int i = 0; i < config.data.size(); i++) {
      (*config.modes[iter_number])[i] =
          config.data[i] - (*config.modes[iter_number])[i];
    }
    for (int i = 0; i < config.data.size(); i++) {
    ...
    if (stop.CheckStop(iter_number, config)) {
      ...
      for (int i = 0; i < iter_number; i++) {
        config.phase_computer_for_mode.compute(*config.modes[i],
                                               *config.phases[i], nullptr);
        config.inst_freq_computer.compute(*config.phases[i],
                                          *config.inst_freqs[i], nullptr);
        config.inst_ampl_computer.inst_freq = config.inst_freqs[i];
        config.inst_ampl_computer.compute(
            *config.modes[i], *config.inst_ampls[i], &computer_buffer);
      }
      break;
    }
    iter_number++;
...
void computeReqDouble(Config &config, Stop &stop) {
  ...
  for (;;) {
    ...
    if (iter_number + 1 > config.inst_freqs.size()) {
      auto *inst_freqs_new =
          new GenericSignal<SimpleVecWrapper<std::pair<double, double>>, true>;
      config.inst_freqs.push_back(inst_freqs_new);
      for (int i = 0; i < config.data.size(); i++) {
    ...
    /*for (int i = 0; i + 1 < iter_number; i++){
        IC(iter_number, i);
        config.inst_freq_computer.compute(*config.phases[i],
    *config.inst_freqs[i], nullptr); config.filter1.compute(config.data,
    *config.modes[iter_number], config.inst_freqs[i]); for(int j = 0; j <
    config.data.size(); j++){
            (*config.modes[i])[j] = (*config.modes[i])[j] + (config.data[j] -
    (*config.modes[iter_number])[j]); config.data[j] =
    (*config.modes[iter_number])[j];
        }

        config.inst_freq_computer.compute(*config.phases[i],
    *config.inst_freqs[i], nullptr); config.filter1.compute(*config.modes[i],
    *config.modes[iter_number], config.inst_freqs[i]); for(int j = 0; j <
    config.data.size(); j++){
            (*config.modes[i])[j] = (*config.modes[i])[j] -
    (*config.modes[iter_number])[j];
            (*config.modes[i+1])[j] = (*config.modes[i+1])[j] +
    (*config.modes[iter_number])[j];
        }

        if(i!=0){
            config.inst_freq_computer.compute(*config.phases[i - 1],
    *config.inst_freqs[i - 1], nullptr);
            config.filter1.compute(*config.modes[i], *config.modes[iter_number],
    config.inst_freqs[i -1]); for(int j = 0; j < config.data.size(); j++){
                (*config.modes[i-1])[j] = (*config.modes[i-1])[j] +
    ...
    // phase_computer_for_mode.compute(*modes[iter_number],
    // *phases[iter_number], nullptr);
    // phases[iter_number]->show(PlottingKind::Simple);
    // inst_freq_computer.compute(*phases[iter_number],
    // *inst_freqs[iter_number], nullptr); inst_ampl_computer.inst_freq =
    // inst_freqs[iter_number]; inst_ampl_computer.compute(*modes[iter_number],
    // *inst_ampls[iter_number], &computer_buffer);
    ...
    if (stop.CheckStop(iter_number, config)) {
      ...
      if (iter_number > config.inst_freqs.size() - 1) {
        auto *inst_freqs_new =
            new GenericSignal<SimpleVecWrapper<std::pair<double, double>>,
                              true>;
        config.inst_freqs.push_back(inst_freqs_new);
        for (int i = 0; i < config.data.size(); i++) {
          config.inst_freqs[iter_number]->base->vec->push_back({0.0, 0.0});
      ...
      for (int i = 0; i < iter_number; i++) {
        ...
        config.inst_freq_computer.compute(*config.phases[i],
                                          *config.inst_freqs[i], nullptr);
        if constexpr (decltype(config.inst_ampl_computer)::
                          is_used_external_inst_freq) {
...
void computeReqCascade(Config &config, Stop &stop) {
  ...
  for (;;) {
    ...
    if (iter_number % 2 == 0) {
      ...
      config.phase_computer.compute(*config.modes[iter_number - 1],
                                    *config.phases[iter_number], nullptr);
      // phases[iter_number]->show(PlottingKind::Simple);
      config.inst_freq_computer.compute(*config.phases[iter_number],
                                        *config.inst_freqs[iter_number],
                                        nullptr);
      config.filter1.compute(*config.modes[iter_number - 1],
                             *config.modes[iter_number],
                             config.inst_freqs[iter_number]);
      // config.modes[iter_number]->show(PlottingKind::Simple);
      for (int i = 0; i < config.data.size(); i++) {
        ...
        (*config.modes[iter_number])[i] =
            bf - (*config.modes[iter_number - 1])[i];
      }
    }
    ...
    *config.inst_freqs[i - 1], nullptr);
    ...
    if (iter_number % 2 == 0) {
      ...
      config.phase_computer.compute(*config.modes[iter_number - 1],
                                    *config.phases[iter_number], nullptr);
      // phases[iter_number]->show(PlottingKind::Simple);
      config.inst_freq_computer.compute(*config.phases[iter_number - 1],
                                        *config.inst_freqs[iter_number],
                                        nullptr);
      config.filter1.compute(*config.modes[iter_number - 1],
                             *config.modes[iter_number],
...
struct InstFreqAndAmplNormSincExtractor {
  ...
  template <Signal DataT> void compute(const DataT &data_in) {
    size_t iter_number = 0;
    ...
    while (true) {
      ...
      if ((*phases[iter_number])[data.size() - 1] > 6.28) {
        ...
        double base_inst_freq = INST_FREQ_COMPUTERS::instFreqNorm(
            data, data_buffer, *inst_freqs[iter_number], freq_conv,
            freq_conv_image);

        phase_computer_simple.compute(data_buffer, *phases[iter_number],
                                      nullptr);

        std::cout << "compute resampled phase  " << iter_number << std::endl;
        phases[iter_number]->show(PlottingKind::Simple);
        base_inst_freq = 1.0 / (static_cast<double>(data.size()) /
                                ((*phases[iter_number])[data.size() - 1] / 2.0 /
                                 std::numbers::pi));
        ...
        filter.compute(data, *modes[iter_number],
                       *phases[iter_number]); // phases is unused
        ...
        label << "/home/dmitry/projects/non-parametric-dsp/examples/"
                 "modes_extractors/images/lf";
        label << iter_number;
        label << ".svg";
        ...
        auto val_expr = [&](size_t idx) { return base_inst_freq; };

        ExpressionWrapper<double, size_t, decltype(val_expr), GENERAL::Nil,
                          decltype(size_expr), false>
            inst_freq_buffer(val_expr, size_expr);

        FILTERS::EXPERIMENTAL::InstAmplNormalizatorNaive<
            double, decltype(inst_ampl_computer), decltype(inst_freq_buffer),
            decltype(non_opt_filter)>
            naive_normalizer = FILTERS::EXPERIMENTAL::InstAmplNormalizatorNaive<
                double, decltype(inst_ampl_computer),
        ...
        FILTERS::EXPERIMENTAL::InstAmplNormalizatorNaiveReqursive<
            ...
            inst_ampl_req_norm =
                FILTERS::EXPERIMENTAL::InstAmplNormalizatorNaiveReqursive<
                    double, decltype(naive_normalizer),
                    decltype(inst_freq_buffer), decltype(non_opt_filter)>(
        ...
        std::cout << "signal with normed inst ampl of last mode  "
        ...
        label2 << "/home/dmitry/projects/non-parametric-dsp/examples/"
                  "modes_extractors/images/filtered";
        label2 << iter_number;
        label2 << ".svg";
        ...
        INST_FREQ_COMPUTERS::backInstFreqNorm(data_buffer, *modes[iter_number],
                                              freq_conv);
        ...
        INST_FREQ_COMPUTERS::backInstFreqNorm(data, *modes[iter_number],
                                              freq_conv);
        std::cout << "last mode back inst freq norm " << iter_number
                  << std::endl;
        modes[iter_number]->show(PlottingKind::Simple);
        phase_computer_simple.compute(*modes[iter_number], *phases[iter_number],
                                      nullptr);
  ...
  template <Signal DataT> void compute(const DataT &data_in) {
    ...
    while (true) {
      ...
      if ((*phases[iter_number])[data.size() - 1] > 6.28) {
        ...
        // std::cout << "bask inst freq norm of mode " << iter_number <<
        // std::endl; modes[iter_number]->show(PlottingKind::Simple);
        ...
        // std::cout << "compute result inst_ampls " << iter_number <<
        // std::endl; inst_ampls[iter_number]->show(PlottingKind::Simple);
...
struct instFreqNormSincExtractorReq {
  ...
  template <typename DataT> void compute(const DataT &data_in) {
    ...
    while (true) {
      ...
      if ((*phases[iter_number])[data.size() - 1] > 6.28) {
        ...
        if (debug) {
          std::cout << "mode phase  " << iter_number << std::endl;
          phases[iter_number]->show(PlottingKind::Simple); //, label.str());
        }
        ...
        if (debug) {
          std::cout << "mode inst_freq  " << iter_number << std::endl;
          inst_freqs[iter_number]->show(PlottingKind::Simple); //, label.str());
        }
        ...
        if (debug) {
          std::cout << "mode inst_ampl  " << iter_number << std::endl;
          inst_ampls[iter_number]->show(PlottingKind::Simple); //, label.str());
        }
  ...
  int getModesCount() { return static_cast<int>(modes.size()); }
  int getDataSize() { return static_cast<int>(modes[0]->size()); }
  std::vector<double> getMode(int idx) { return *(modes[idx]->base->vec); }
  ...
  std::vector<double> getPhase(int idx) { return *(phases[idx]->base->vec); }
};
...
struct instFreqNormSincExtractorReqV2 {
  ...
  FILTERS::EXPERIMENTAL::SincResLocalFilterWithResReqV2<
      double, decltype(phase_computer_simple)>
      filter;
    ...
    while (true) {
      ...
      if ((*phases[iter_number])[data.size() - 1] >= 6.28) {
        ...
        for (size_t i = 0; i < phases[iter_number]->size(); i++) {
          (*inst_freqs[iter_number])[i] =
              phase_computer_simple.derive(i) / std::numbers::pi / 2.0;
        }
...
struct instFreqNormSincReverseSolveNonDeterminity {
  ...
  FILTERS::EXPERIMENTAL::
      SincResLocalFilterWithResSolveNoneDeterminityLowFreqReq<
          double, decltype(phase_computer_simple), decltype(inst_freq_computer)>
          filter;
...
struct SOTAEMD {
  ...
  FILTERS::InterpolationKind interpolation_kind =
      FILTERS::InterpolationKind::Makima;

...
namespace NP_DSP::ONE_D::APPROX {
    ...
    //Аппроксимация модифицированным сплайном Акимы 
    ...
    struct InverseDistanceWeightingBasedWithNoTrain {
        ...
        template<typename U>
        void loadNDData(const U & x, const U & y, int n_dims_x, int n_dims_y, int n_elems){
            alglib::real_2d_array data;
    ...
    struct RBFBasedWithNoTrain {
        ...
        */
        ...
        template<typename IdxT>
        double computeDerive(const IdxT & idx){
            //todo
            alglib::real_1d_array idx_;
            idx_.setlength(1);
            idx_[0] = idx;

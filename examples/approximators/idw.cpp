...
int main(){
    int N = 100;
    NP_DSP::ONE_D::APPROX::InverseDistanceWeightingBasedWithNoTrain approximator;
    ...
    NP_DSP::ONE_D::APPROX::InverseDistanceWeightingBasedWithNoTrain approximator2d;
    approximator2d.loadNDData<decltype(x_for_load)>(x_for_load, y_for_load, 2, 1, N*N);

    using namespace matplot;
    auto [X, Y] = meshgrid(iota(0, 0.2, N));

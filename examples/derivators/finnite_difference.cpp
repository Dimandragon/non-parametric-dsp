...
int main(){
    ...
    NP_DSP::ONE_D::DERIVATORS::FinniteDifference<double, NP_DSP::ONE_D::DERIVATORS::FinniteDifferenceType::Forward> derivator;
    for (auto i = 0; i < 5000; i++){
        static_cast<NP_DSP::ONE_D::SimpleVecWrapper<double> *>(signal1.base)->vec->push_back(-std::cos(static_cast<double>(i) / 100.0) * 100 + 100);
    ...
    derivator.compute(signal1, signal2, nullptr);
    ...
    NP_DSP::ONE_D::DERIVATORS::FinniteDifference<double, NP_DSP::ONE_D::DERIVATORS::FinniteDifferenceType::Central> derivator2;
    derivator2.compute(signal1, signal2, nullptr);
    ...
    NP_DSP::ONE_D::DERIVATORS::FinniteDifference<double, NP_DSP::ONE_D::DERIVATORS::FinniteDifferenceType::Backward> derivator3;
    derivator3.compute(signal1, signal2, nullptr);

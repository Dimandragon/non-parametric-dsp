...
target("test_plotting_for_spectrogramm")
    set_kind("binary")
    add_files("examples/spectrogramms/test_plotting.cpp")
    add_deps("matplot++_external")
    add_deps("non-parametric_dsp")
    add_deps("icecream")
...
target("makima_interpolation_based")
    set_kind("binary")
    add_files("examples/filters/makima_interpolation_based.cpp")
    add_deps("matplot++_external")
    add_deps("non-parametric_dsp")
    add_deps("icecream")

target("square_interpolation")
    set_kind("binary")
    add_files("examples/utility/simple_interpolation.cpp")
    add_deps("matplot++_external")
    add_deps("non-parametric_dsp")
    add_deps("icecream")

target("phase_shifting_example")
    set_kind("binary")
    add_files("examples/phase_shifting/phase_shifting.cpp")
    add_deps("matplot++_external")
    add_deps("non-parametric_dsp")
    add_deps("icecream")

target("phase_shifting_circular")
    set_kind("binary")
    add_files("examples/phase_shifting/circular_phase_shifting.cpp")
    add_deps("matplot++_external")
    add_deps("non-parametric_dsp")
    add_deps("icecream")
...
target("rbf_spline_approx")
    set_kind("binary")
    add_files("examples/approximators/rbfspline.cpp")
    add_deps("matplot++_external")
    add_deps("non-parametric_dsp")
    add_deps("icecream")
